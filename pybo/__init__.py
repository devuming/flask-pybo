...
def create_app():
    ...
    from .views import main_views, question_views, answer_views, auth_views, comment_views, vote_views, profile_views, settings_views
    ...
    app.register_blueprint(settings_views.bp)
